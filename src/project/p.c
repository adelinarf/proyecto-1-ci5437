...
#define num_fwd_rules 32
#define num_bwd_rules 39
static const char *fwd_rule_name[ 32 ] = { "1_IZQUIERDA", "1_ARRIBA", "1_ABAJO", "1_DERECHA", "2_IZQUIERDA", "2_ARRIBA", "2_ABAJO", "2_DERECHA", "3_IZQUIERDA", "3_ARRIBA", "3_ABAJO", "3_DERECHA", "4_IZQUIERDA", "4_ARRIBA", "4_ABAJO", "4_DERECHA", "5_IZQUIERDA", "5_ARRIBA", "5_ABAJO", "5_DERECHA", "6_IZQUIERDA", "6_ARRIBA", "6_ABAJO", "6_DERECHA", "7_IZQUIERDA", "7_ARRIBA", "7_ABAJO", "7_DERECHA", "8_IZQUIERDA", "8_ARRIBA", "8_ABAJO", "8_DERECHA" };
#define get_fwd_rule_label( ruleid ) (fwd_rule_name[(ruleid)]) 
static const char *bwd_rule_name[ 39 ] = { "1_IZQUIERDA", "1_ARRIBA", "1_ABAJO", "1_DERECHA", "2_IZQUIERDA", "2_ARRIBA", "2_ABAJO", "2_DERECHA", "2_DERECHA", "2_DERECHA", "2_DERECHA", "2_DERECHA", "2_DERECHA", "2_DERECHA", "2_DERECHA", "3_IZQUIERDA", "3_ARRIBA", "3_ABAJO", "3_DERECHA", "4_IZQUIERDA", "4_ARRIBA", "4_ABAJO", "4_DERECHA", "5_IZQUIERDA", "5_ARRIBA", "5_ABAJO", "5_DERECHA", "6_IZQUIERDA", "6_ARRIBA", "6_ABAJO", "6_DERECHA", "7_IZQUIERDA", "7_ARRIBA", "7_ABAJO", "7_DERECHA", "8_IZQUIERDA", "8_ARRIBA", "8_ABAJO", "8_DERECHA" };
...
static int fwd_rule_label_sets[256] = {0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7};

static int bwd_rule_label_sets[312] = {0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7,0,1,2,3,4,5,6,7};
...
static actfuncptr fwd_rules[ 32 ] = { fwdrule1, fwdrule2, fwdrule3, fwdrule4, fwdrule5, fwdrule6, fwdrule7, fwdrule8, fwdrule9, fwdrule10, fwdrule11, fwdrule12, fwdrule13, fwdrule14, fwdrule15, fwdrule16, fwdrule17, fwdrule18, fwdrule19, fwdrule20, fwdrule21, fwdrule22, fwdrule23, fwdrule24, fwdrule25, fwdrule26, fwdrule27, fwdrule28, fwdrule29, fwdrule30, fwdrule31, fwdrule32 };

static int fwdfn7_a0_3( const state_t *state, void *next_func )
{
...
static int fwdfn6_a0_3( const state_t *state, void *next_func )
{
...
static int fwdfn5_a0_3( const state_t *state, void *next_func )
{
...
static int fwdfn4_a0_3( const state_t *state, void *next_func )
{
...
static int fwdfn3_a0_3( const state_t *state, void *next_func )
{
...
static int fwdfn2_a0_3( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn3;
  return 11;
}

static int fwdfn2_a0_2( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn2_a0_3;
  return 10;
}

static int fwdfn2_a0_1( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn2_a0_2;
  return 9;
}
...
static int fwdfn1_a0_3( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn2;
  return 7;
}

static int fwdfn1_a0_2( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn1_a0_3;
  return 6;
}

static int fwdfn1_a0_1( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn1_a0_2;
  return 5;
}
...
static int fwdfn0_a0_3( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn1;
  return 3;
}

static int fwdfn0_a0_2( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn0_a0_3;
  return 2;
}

static int fwdfn0_a0_1( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = fwdfn0_a0_2;
  return 1;
}
...
static actfuncptr bwd_rules[ 39 ] = { bwdrule1, bwdrule2, bwdrule3, bwdrule4, bwdrule5, bwdrule6, bwdrule7, bwdrule8, bwdrule9, bwdrule10, bwdrule11, bwdrule12, bwdrule13, bwdrule14, bwdrule15, bwdrule16, bwdrule17, bwdrule18, bwdrule19, bwdrule20, bwdrule21, bwdrule22, bwdrule23, bwdrule24, bwdrule25, bwdrule26, bwdrule27, bwdrule28, bwdrule29, bwdrule30, bwdrule31, bwdrule32, bwdrule33, bwdrule34, bwdrule35, bwdrule36, bwdrule37, bwdrule38, bwdrule39 };

static int bwdfn7_a0_11( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = NULL;
  return 36;
}

static int bwdfn7_a0_10( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_11;
  return 23;
}

static int bwdfn7_a0_9( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_10;
  return 20;
}

static int bwdfn7_a0_8( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_9;
  return 18;
}

static int bwdfn7_a0_7( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_8;
  return 14;
}

static int bwdfn7_a0_6( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_7;
  return 13;
}

static int bwdfn7_a0_5( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_6;
  return 12;
}

static int bwdfn7_a0_4( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_5;
  return 11;
}

static int bwdfn7_a0_3( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_4;
  return 10;
}

static int bwdfn7_a0_2( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn7_a0_3;
  return 9;
}
...
static int bwdfn6_a0_3( const state_t *state, void *next_func )
{
...
static int bwdfn5_a0_3( const state_t *state, void *next_func )
{
...
static int bwdfn4_a0_3( const state_t *state, void *next_func )
{
...
static int bwdfn3_a0_3( const state_t *state, void *next_func )
{
...
static int bwdfn2_a0_3( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn3;
  return 27;
}

static int bwdfn2_a0_2( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn2_a0_3;
  return 25;
}

static int bwdfn2_a0_1( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn2_a0_2;
  return 22;
}
...
static int bwdfn1_a0_3( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn2;
  return 24;
}

static int bwdfn1_a0_2( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn1_a0_3;
  return 4;
}

static int bwdfn1_a0_1( const state_t *state, void *next_func )
{
  *((funcptr *)next_func) = bwdfn1_a0_2;
  return 1;
}
...
static int bwdfn0_a0_2( const state_t *state, void *next_func )
{
...
static const int bw_max_children = 39;
#define max_bwd_children 39
...
{
  if( state->vars[ 0 ] == 1 && state->vars[ 1 ] == 2 && state->vars[ 2 ] == 3 && state->vars[ 3 ] == 4 && state->vars[ 4 ] == 5 && state->vars[ 5 ] == 6 && state->vars[ 6 ] == 7 && state->vars[ 7 ] == 0 ) {
    return 1;
  }
  return 0;
}
